...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('public/Assets')}}/admin/../../assets/images/favicon.png">
                ...
                <div class="form-input-content">
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5">
                            <a class="text-center" href="index.html"> <h4>DeliveryBoy Login</h4></a>
                            <form class="mt-5 mb-5 login-input" method="post" action="{{url('deliveryboy')}}/auth">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{url('deliveryboy')}}/forgetpassword" class="text-primary">Forgot Password?</a>
                                </div>
