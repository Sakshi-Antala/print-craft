        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">OrderDetail List</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            @foreach($odetail as $key=>$value)
                                                ...
                                                <tr>
                                                    ...
                                                    {{--@if($value->user_uploaded_design=='')--}}
                                                    {{--<td class="text-center">--</td>--}}
                                                    {{--@else--}}
                                                    {{--<td class="text-center">{{$value->user_uploaded_design}}</td>--}}
                                                    {{--@endif--}}
                                                </tr>
                                            @endforeach
                                            </tbody>
