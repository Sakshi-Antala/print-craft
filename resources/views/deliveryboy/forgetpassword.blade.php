                ...
                <div class="form-input-content">
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5">
                            <a class="text-center" href="javascript:;"> <h4>Forget Password</h4></a>
                            <form class="mt-5 mb-5 login-input" method="post" action="{{url('deliveryboy')}}/getlink">
                                @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Email" name="email">
                                </div>
                                <span style="color: red;">{{session()->get('message')}}</span>
                                <button class="btn login-form__btn submit w-100">Get Link</button>
                            </form>
                        </div>
                    </div>
                </div>
