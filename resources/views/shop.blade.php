                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{asset('public/Assets')}}/img/product-img/{{(isset($image[$val->pid]->url)?$image[$val->pid]->url:'demo.png')}}" id="{{$key}}" style="max-height: 320px;">
...
@section('script')
    <script>
     ...
     function change(img,c,key,url) {
            $('#'+c).html('<div class="product__item__pic set-bg" data-setbg="'+img+'" style="background-image: url(&quot;'+img+'&quot;);max-height: 320px;">\
...
//         alert($("div").filter('.product__item').attr('id'));
     ...
     function leave(c,key,url) {
         $('#'+c).html('<div class="product__item__pic set-bg" data-setbg="'+url+'" style="background-image: url(&quot;&quot;);max-height: 320px;">\
                 <div class="label new">New</div>\
                 <ul class="product__hover">\
                 <li><a href="'+url+'" class="image-popup"><span class=""><i class="fa fa-1x fa-info-circle" aria-hidden="true"></i></span></a></li>\
                 <li><a href="#"><span class="icon_heart_alt"></span></a></li>\
