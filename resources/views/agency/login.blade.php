                ...
                <div class="form-input-content">
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5">
                            <a class="text-center" href="javascript:;"> <h4>Agency Login</h4></a>
                            <form class="mt-5 mb-5 login-input" method="post" action="{{url('agency')}}/auth">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{url('agency')}}/forgetpassword" class="text-primary">Forgot Password?</a>
                                </div>
