        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">ADD PAPERSTOCK</h3><br>
                            <div class="basic-form">
                                <form action="{{url('agency')}}/insertpaperstock" method="post">
                                    @csrf
                                ...
                                <table class="table header-border" id="datatable" style="width: 100%;">
                                    ...
                                    @foreach($pstock as $val)
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>{{$val->m_type}}</td>
                                            <td><span><a href="{{url('agency/fetchpaperstock')}}/{{$val->p_s_id}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted m-r-5"></i> </a><a href="{{url('agency/deletepaperstock/')}}/{{$val->p_s_id}}" data-toggle="tooltip" data-placement="top" title="Close"><i class="fa fa-close color-danger"></i></a></span>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
