        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">ADD SIZE</h3><br>
                            <div class="basic-form">
                                <form action="{{url('agency')}}/insertsize" method="post">
                                    @csrf
                                ...
                                <table class="table header-border" id="datatable" style="width: 100%;">
                                    ...
                                    @foreach($size as $val)
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>{{$val->size}}</td>
                                            <td><span><a href="{{url('agency/fetchsize')}}/{{$val->size_id}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted m-r-5"></i> </a><a href="{{url('agency/deletesize/')}}/{{$val->size_id}}" data-toggle="tooltip" data-placement="top" title="Close"><i class="fa fa-close color-danger"></i></a></span>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
