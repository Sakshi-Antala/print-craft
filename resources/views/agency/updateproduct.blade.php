                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="post" action="{{url('agency')}}/updateproduct/{{$product->pid}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{asset('public/Assets')}}/img/product-img/{{$value->url}}" width="100" height="100">
                                            <a href="{{url('agency/deleteimage')}}/{{$value->p_i_id}}/{{$value->pid}}"><button type="button" class="btn btn-success btn-sm">Delete</button>
                                            </a>
                                        @endforeach
                                    </div>
                                    ...
                                    @foreach($attr as $val)
                                        <div class="form-row" id="pa{{$loop_count++}}">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <img src="{{asset('public/Assets')}}/img/product-color-img/{{$val->url}}" width="100" height="100"><br><br>
                                                    <input type="file"  class="form-control-file" name="cimage[]" value="">
                                                </div>
                                            </div>
                                            {{--@endif--}}
                                            @if($loop_count==2)
                                            ...
                                            @else
                                                <div class="form-group">
                                                    {{--<button type="button" class="btn  btn-success" id="button">Add<span class="btn-icon-right"><i class="fa fa-plus"></i></span></button>--}}
                                                    <a href="{{url('agency/deleteproductattr/')}}/{{$val->p_a_id}}/{{$val->pid}}"> <button type="button" class="btn  btn-danger" id="button1">Remove<span class="btn-icon-right"><i class="fa fa-minus"></i></span></button></a>
                                                </div>
                                            @endif
                                        </div>
                                    @endforeach
