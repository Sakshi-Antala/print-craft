                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{url('admin')}}/insertcolor" method="post">
                                    @csrf
                                ...
                                <table class="table header-border" id="datatable" style="width: 100%;">
                                    ...
                                    @foreach($color as $val)
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td>{{$val->name}}</td>
                                            <td><span><a href="{{url('admin/fetchcolor')}}/{{$val->color_id}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted m-r-5"></i> </a><a href="{{url('admin/deletecolor/')}}/{{$val->color_id}}" data-toggle="tooltip" data-placement="top" title="Close"><i class="fa fa-close color-danger"></i></a></span>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
