                            ...
                            <div class="basic-form">
                                <form action="{{url('admin')}}/insertcategory" method="post">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form-control-md" type="text" placeholder="Category" name="cname" value="{{old('cname')}}">
                                ...
                                <table class="table header-border" id="datatable" style="width: 100%;">
                                    ...
                                    @foreach($category as $val)
                                        <tr>
                                            ...
                                            <td>{{$val->cat_id}}</td>
                                            <td>{{$val->cname}}</td>
                                            <td><span><a href="{{url('admin/fetchcategory')}}/{{$val->cat_id}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted m-r-5"></i> </a><a href="{{url('admin/deletecategory/')}}/{{$val->cat_id}}" data-toggle="tooltip" data-placement="top" title="Close"><i class="fa fa-close color-danger"></i></a></span>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
