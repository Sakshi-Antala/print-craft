                                ...
                                <table class="table header-border responsive" id="datatable" style="width: 100%;">
                                    ...
                                    @foreach($order as $val)
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="{{url('admin')}}/orderdetail/{{$val->o_id}}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title">DeliveryBoy List</h5>
                            <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                            </button>
                        </div>
                        <input type="hidden" id="oid" name="oid">
                        <div class="modal-body">
                            <select class="form-control form-control-md mb-3" name="d_b_id" id="d_b_id">
